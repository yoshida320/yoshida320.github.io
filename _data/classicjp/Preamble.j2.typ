...
#show: rendercv.with(
  ...
  typography-font-family-body: ("Hiragino Sans", "{{ design.typography.font_family.body }}"),
  typography-font-family-name: ("{{ design.typography.font_family.name }}", "Hiragino Sans"),
  typography-font-family-headline: ("{{ design.typography.font_family.headline }}", "Hiragino Sans"),
  typography-font-family-connections: ("{{ design.typography.font_family.connections }}", "Hiragino Sans"),
  typography-font-family-section-titles: ("{{ design.typography.font_family.section_titles }}", "Hiragino Sans"),
